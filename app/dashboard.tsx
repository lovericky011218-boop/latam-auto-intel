...
const groupLabels: Record<string,string> = {"BYD集团":"BYD","Chery集团":"CHERY","Geely集团":"GEELY","GWM集团":"GWM","东风集团":"DONGFENG","Leapmotor集团":"LEAPMOTOR","Changan集团":"CHANGAN","XPENG集团":"XPENG","NIO集团":"NIO","GAC集团":"GAC"};
...
"Geely集团|Lynk&Co|Lynk & Co 01|US$ 49.990|PHEV Halo FWD:US$ 49.990|lynk-uy","Geely集团|Lynk&Co|Lynk & Co 02|US$ 36.990|BEV Pro RWD:US$ 36.990,BEV Halo RWD:询价|lynk-uy","Geely集团|Lynk&Co|Lynk & Co 06|US$ 31.990|ICE Pro FWD:US$ 31.990|lynk-uy","Geely集团|Lynk&Co|Lynk & Co 08|US$ 54.990|PHEV Pro FWD:US$ 54.990,PHEV Halo FWD:询价|lynk-uy","Geely集团|Lynk&Co|Lynk & Co 09|US$ 69.990|MHEV Ultra AWD:US$ 69.990|lynk-uy","Geely集团|Lynk&Co|Lynk & Co 03+|US$ 69.990|ICE AWD:US$ 69.990|lynk-uy",
...
"Geely集团|Geely|GX3 Pro|US$ 18.990|Comfort:询价|geely-ec","Geely集团|Geely|Coolray|US$ 25.990|GF:询价|geely-ec","Geely集团|Geely|Cityray|US$ 30.990|GF:询价|geely-ec","Geely集团|Geely|EX5|US$ 39.990|Max:询价|geely-ec","Geely集团|Lynk&Co|Lynk & Co 01|US$ 43.990|PHEV FWD:询价|lynk-ec","Geely集团|Lynk&Co|Lynk & Co 02|询价|BEV RWD:询价|lynk-ec","Geely集团|Lynk&Co|Lynk & Co 06|询价|ICE FWD:询价|lynk-ec","Geely集团|Lynk&Co|Lynk & Co 08|询价|PHEV Pro FWD:询价,PHEV Halo FWD:询价|lynk-ec","Geely集团|Lynk&Co|Lynk & Co 09|询价|MHEV AWD:询价|lynk-ec",
...
const gacLatamRaw: Record<string,string[]> = {
  "巴西":[
    "GAC集团|GAC|GS9|询价|ICE:询价|gac-br","GAC集团|AION|AION UT|询价|BEV FWD:询价|gac-br","GAC集团|GAC|GS3 EMZOOM|询价|ICE FWD:询价|gac-br","GAC集团|HYPTEC|HYPTEC HT|询价|BEV RWD:询价|gac-br","GAC集团|AION|AION V|询价|BEV FWD:询价|gac-br","GAC集团|GAC|GS4 Hybrid|询价|HEV FWD:询价|gac-br","GAC集团|AION|AION ES|询价|BEV FWD:询价|gac-br","GAC集团|AION|AION Y|询价|BEV FWD:询价|gac-br",
  ],
  "阿根廷":[
    "GAC集团|AION|AION UT|询价|BEV FWD:询价|gac-ar","GAC集团|GAC|EMKOO|询价|ICE FWD:询价|gac-ar","GAC集团|GAC|GS8|询价|ICE FWD:询价|gac-ar","GAC集团|GAC|S7|询价|PHEV:询价|gac-ar","GAC集团|GAC|EMPOW|询价|ICE FWD:询价|gac-ar","GAC集团|GAC|GS3 EMZOOM|询价|ICE FWD:询价|gac-ar","GAC集团|AION|AION ES|询价|BEV FWD:询价|gac-ar",
  ],
  "智利":[
    "GAC集团|GAC|GS3 Power|CLP 9.990.000|ICE FWD:CLP 9.990.000|gac-cl","GAC集团|GAC|GS4 Power|CLP 14.490.000|ICE FWD:CLP 14.490.000|gac-cl","GAC集团|GAC|GS3 EMZOOM|CLP 11.490.000|ICE FWD:CLP 11.490.000|gac-cl","GAC集团|GAC|EMKOO|CLP 15.490.000|ICE FWD:CLP 15.490.000,HEV FWD:CLP 24.990.000|gac-cl","GAC集团|GAC|GS8|CLP 21.990.000|ICE FWD:CLP 21.990.000|gac-cl","GAC集团|GAC|EMPOW|CLP 17.990.000|ICE FWD:CLP 17.990.000|gac-cl","GAC集团|AION|AION Y|CLP 25.500.000|BEV FWD:CLP 25.500.000|gac-cl","GAC集团|AION|AION ES|CLP 19.990.000|BEV FWD:CLP 19.990.000|gac-cl",
  ],
  "乌拉圭":[
    "GAC集团|AION|AION ES|US$ 26.990|BEV FWD:US$ 26.990|gac-uy","GAC集团|AION|AION UT|US$ 22.490|BEV FWD:US$ 22.490|gac-uy","GAC集团|AION|AION V|US$ 28.990|BEV FWD:US$ 28.990|gac-uy","GAC集团|GAC|EMKOO|US$ 28.990|HEV FWD:US$ 28.990|gac-uy","GAC集团|GAC|GS3 EMZOOM|US$ 29.490|ICE FWD:US$ 29.490|gac-uy","GAC集团|GAC|GS8|US$ 55.490|ICE FWD:US$ 55.490|gac-uy","GAC集团|HYPTEC|HYPTEC HT|US$ 45.990|BEV RWD:US$ 45.990|gac-uy",
  ],
  "玻利维亚":[
    "GAC集团|GAC|GS3|询价|ICE FWD:询价|gac-bo","GAC集团|GAC|GS3 EMZOOM|询价|ICE FWD:询价|gac-bo","GAC集团|GAC|GS4 MAX|询价|ICE FWD:询价|gac-bo","GAC集团|GAC|EMKOO|询价|ICE FWD:询价|gac-bo","GAC集团|GAC|S7|询价|PHEV:询价,REEV:询价|gac-bo","GAC集团|GAC|GS8|询价|ICE FWD:询价|gac-bo","GAC集团|GAC|M6 Pro|询价|ICE FWD:询价|gac-bo","GAC集团|AION|AION UT|询价|BEV FWD:询价|gac-bo","GAC集团|AION|AION i60|询价|BEV FWD:询价,REEV FWD:询价|gac-bo","GAC集团|HYPTEC|HYPTEC HT|询价|BEV RWD:询价|gac-bo",
  ],
  "厄瓜多尔":[
    "GAC集团|GAC|GS8|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|EMKOO|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|GS4|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|GS3 EMZOOM|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|GS3 Power|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|GS3|询价|ICE FWD:询价|gac-ec","GAC集团|GAC|EMPOW|询价|ICE FWD:询价|gac-ec","GAC集团|AION|AION Y|询价|BEV FWD:询价|gac-ec","GAC集团|AION|AION ES|询价|BEV FWD:询价|gac-ec",
  ],
  "秘鲁":[
    "GAC集团|GAC|GS3 EMZOOM|询价|ICE FWD:询价|gac-pe","GAC集团|GAC|GS8|询价|ICE FWD:询价|gac-pe","GAC集团|GAC|M8|询价|ICE FWD:询价,PHEV FWD:询价|gac-pe","GAC集团|GAC|Smilodon Pro|询价|ICE 4WD:询价|gac-pe","GAC集团|AION|AION Y Plus|询价|BEV FWD:询价|gac-pe","GAC集团|AION|AION i60|询价|BEV FWD:询价,REEV FWD:询价|gac-pe","GAC集团|GAC|S7|询价|PHEV:询价,REEV:询价|gac-pe",
  ],
};
...
"geely-br":{name:"Geely Brasil｜车型与官方优惠",url:"https://www.geelybrasil.com.br"},"geely-ar":{name:"Geely Argentina｜车型官网",url:"https://geelyargentina.com.ar"},"geely-cl":{name:"Geely Chile｜车型与价格",url:"https://www.geely.cl/cotizar"},"geely-uy":{name:"Geely Uruguay｜车型与价格",url:"https://geely.com.uy"},"geely-bo":{name:"Geely Bolivia｜车型官网",url:"https://geely.com.bo"},"geely-ec":{name:"Geely Ecuador｜车型官网",url:"https://geely.com.ec"},"geely-pe":{name:"Geely Perú｜车型与官方起售价",url:"https://geely.pe/"},"zeekr-cl":{name:"ZEEKR Chile｜品牌官网",url:"https://www.zeekr.cl"},"lynk-cl":{name:"Lynk & Co Chile｜本地官方车型目录",url:"https://www.lynkco.funnelbox.cl/"},"lynk-ec":{name:"Lynk & Co Ecuador｜本地官方车型目录",url:"https://www.lynkcoecuador.com.ec/"},"lynk-uy":{name:"Lynk & Co Uruguay｜本地官方车型与售价",url:"https://lynkco.uy/"},
...
const splitPowertrains = (c: BaseCar): PowerCar[] => {
  ...
  if(c.model==="EMKOO"){
    const hasIce=c.trims.some(t=>/ICE/i.test(t.name)),hasHev=c.trims.some(t=>/HEV|Hybrid/i.test(t.name));
    return [...(hasIce?[ice(/ICE/i)]:[]),...(hasHev?[hev(/HEV|Hybrid/i)]:[])];
  }
  if(c.model==="M8"){
    const hasIce=c.trims.some(t=>/ICE/i.test(t.name)),hasPhev=c.trims.some(t=>/PHEV/i.test(t.name));
    return [...(hasIce?[ice(/ICE/i)]:[]),...(hasPhev?[phev(/PHEV/i)]:[])];
  }
  if(c.model==="S7"){
    const hasPhev=c.trims.some(t=>/PHEV/i.test(t.name)),hasReev=c.trims.some(t=>/REEV/i.test(t.name));
    return [...(hasPhev?[phev(/PHEV/i)]:[]),...(hasReev?[reev(/REEV/i)]:[])];
  }
  if(c.model==="AION i60"){
    const hasBev=c.trims.some(t=>/BEV|EV/i.test(t.name)),hasReev=c.trims.some(t=>/REEV/i.test(t.name));
    return [...(hasBev?[bev(/BEV|EV/i)]:[]),...(hasReev?[reev(/REEV/i)]:[])];
  }
  if(c.model==="GS9") return [make("PHEV / REEV","插混 PHEV / 增程 REEV",c.use,c.range)];
...
const splitDrivetrains = (c: PowerCar): Car[] => {
  ...
  if(c.model==="Zeekr 009"){
    const fwd=match(/FWD|前驱|Executive/i),awd=match(/AWD|四驱|Luxury|Premium|Flagship/i);
    if(fwd.length||awd.length) return [...(fwd.length?[record("前驱",fwd)]:[]),...(awd.length?[record("四驱",awd)]:[])];
    return [record("四驱")];
  }
  if(c.model==="Poer"){
...
const trimEnergyDetail = (car:Car, trim:Trim) => {
  ...
  if(car.model==="Zeekr 7GT") return /Business|75/i.test(n)?{battery:"75 kWh",range:"519 km WLTP"}:{battery:"100 kWh",range:car.drive==="四驱"?"558 km WLTP":"655 km WLTP"};
  if(car.model==="Zeekr 9X") return {battery:"55 kWh",range:"179 km 纯电 / 737 km 综合 WLTP*"};
...
const rangeValue = (text:string) => {
  const values=[...text.matchAll(/([\d,.]+)\s*km/gi)].map(match=>Number(match[1].replace(/\D/g,""))).filter(Boolean);
  return values.length?Math.max(...values):null;
};
const carRangeValue = (car:Car) => {
  const values=[rangeValue(car.range),...car.trims.map(trim=>rangeValue(trimEnergyDetail(car,trim).range))].filter((value):value is number=>value!==null);
  return values.length?Math.max(...values):null;
};
const priceCeiling = Math.max(500000,Math.ceil(Math.max(...cars.map(car=>carPriceValue(car)||0))/100000)*100000);
const priceStep = 10000;
const formatPriceBound = (value:number) => value>=10000?`¥${(value/10000).toLocaleString("zh-CN")}万`:`¥${value.toLocaleString("zh-CN")}`;
const lengthValue = (car:Car) => {
  const match=car.dims.match(/([\d,]+)/);
  if(!match) return null;
  const value=Number(match[1].replace(/\D/g,""));
  return value>=2500?value:null;
};
const lengthFloor = 4000;
const lengthCeiling = Math.max(5500,Math.ceil(Math.max(...cars.map(car=>lengthValue(car)||0))/100)*100);
const lengthStep = 100;
const formatLength = (value:number) => `${value.toLocaleString("zh-CN")} mm`;
...
const modelIdentityAliases: Record<string,string> = {
  ...
  "BYD|Yuan Up DM-i":"BYD Atto 2 / Yuan Up",
  ...
  "Geely|EX5":"Geely EX5 family",
  "Geely|EX5 EM-i":"Geely EX5 family",
  "AION|AION Y":"AION Y / Y Plus",
  "AION|AION Y Plus":"AION Y / Y Plus",
  "GAC|M8":"GAC M8 / GN8",
  "GAC|M8 PHEV":"GAC M8 / GN8",
  "GAC|GN8 PHEV":"GAC M8 / GN8",
  "GAC|GS3":"GAC GS3 family",
  "GAC|GS3 Power":"GAC GS3 family",
  "GAC|GS3 EMZOOM":"GAC GS3 family",
  "GAC|GS4":"GAC GS4 family",
  "GAC|GS4 Power":"GAC GS4 family",
  "GAC|GS4 MAX":"GAC GS4 family",
...
const summarizeModelRecords=(records:Car[]):BrandModelOverview=>{
  const first=records[0],key=canonicalModel(first.brand,first.model);
...
export default function Home(){
  ...
  const lengthActive=lengthMin>lengthFloor||lengthMax<lengthCeiling;
  const filtered=useMemo(()=>{
    const matches=cars.filter(c=>{
      const price=carPriceValue(c);
      const length=lengthValue(c),effectiveLengthMin=lengthMin===lengthFloor?0:lengthMin;
    ...
    return [...matches].sort((a,b)=>{
      if(sortBy==="priceAsc"||sortBy==="priceDesc"){
        ...
        if(av===null) return 1;
        if(bv===null) return -1;
        return sortBy==="priceAsc"?av-bv:bv-av;
      }
      if(sortBy==="rangeAsc"||sortBy==="rangeDesc"){
        const av=carRangeValue(a),bv=carRangeValue(b);
        if(av===null&&bv===null) return 0;
        if(av===null) return 1;
        if(bv===null) return -1;
        return sortBy==="rangeAsc"?av-bv:bv-av;
      }
      if(sortBy==="verifiedDesc") return b.verified.localeCompare(a.verified);
      if(sortBy==="nameAsc") return `${a.brand} ${a.model}`.localeCompare(`${b.brand} ${b.model}`,undefined,{numeric:true});
      return 0;
    });
  ...
  const brandFootprint=brandCatalog.map(item=>{
    const modelFamilies=new Map<string,Car>();
    cars.filter(c=>c.brand===item.brand).forEach(car=>{
      const family=canonicalModel(car.brand,car.model);
      if(!modelFamilies.has(family)) modelFamilies.set(family,car);
    });
    const models=[...modelFamilies.keys()];
    const bodyCounts:Record<BodyType,number>={"轿车":0,"SUV":0,"MPV":0,"皮卡":0};
    modelFamilies.forEach(car=>{bodyCounts[bodyTypeOf(car.model)]+=1});
    return {...item,models,count:models.length,bodyCounts};
  ...
  useEffect(()=>{if(!allBasicFilters)setShowRawRecords(false)},[allBasicFilters]);
  useEffect(()=>{
    if(!overviewActive) return;
    const timer=window.setTimeout(()=>{
      const lineup=document.getElementById("lineup");
      if(lineup) window.scrollTo({top:lineup.getBoundingClientRect().top+window.scrollY-72,behavior:"smooth"});
    },120);
    return ()=>window.clearTimeout(timer);
  },[overviewActive,overviewBrand]);
  ...
  return <main className="shell">
    ...
    <section className="filterPanel" id="lineup">
      ...
      <div className="filterTools"><button className="advancedToggle" onClick={()=>setShowAdvancedFilters(value=>!value)}>{showAdvancedFilters?"收起高级筛选 ↑":"展开车身 / 尺寸 / 价格 / 动力 / 驱动 / 安全筛选 ↓"}</button><button className="reset" onClick={reset}>重置筛选</button></div>
      {showAdvancedFilters&&<div className="advancedFilters">
        <div className="filterRow bodyRow"><span className="filterLabel">车身</span><div className="pills">{["全部车身","轿车","SUV","MPV","皮卡"].map(x=><button className={body===x?"active":""} onClick={()=>{setBody(x);setVisible(24)}} key={x} title={x==="轿车"?"含三厢、两厢及旅行车":""}>{x.replace("全部车身","全部")}</button>)}</div><small>轿车含三厢、两厢及旅行车</small></div>
        <div className="priceRangeRow dimensionRangeRow"><span className="filterLabel">车长</span><div className="priceRange dimensionRange"><div className="rangeLabels"><b>{lengthMin===lengthFloor?`≤ ${formatLength(lengthFloor)}`:formatLength(lengthMin)}</b><span>官方车长区间 · 100 mm 步长</span><b>{lengthMax===lengthCeiling?"不限上限":formatLength(lengthMax)}</b></div><div className="rangeInputs"><label><small>最短</small><input aria-label="最短车身长度" type="range" min={lengthFloor} max={lengthCeiling} step={lengthStep} value={lengthMin} onInput={e=>{setLengthMin(Math.min(Number(e.currentTarget.value),lengthMax-lengthStep));setVisible(24)}}/></label><label><small>最长</small><input aria-label="最长车身长度" type="range" min={lengthFloor} max={lengthCeiling} step={lengthStep} value={lengthMax} onInput={e=>{setLengthMax(Math.max(Number(e.currentTarget.value),lengthMin+lengthStep));setVisible(24)}}/></label></div><div className="pricePresets lengthPresets" aria-label="常用车长区间"><button className={lengthMin===lengthFloor&&lengthMax===4300?"active":""} onClick={()=>{setLengthMin(lengthFloor);setLengthMax(4300);setVisible(24)}}>4.3m以内</button><button className={lengthMin===4300&&lengthMax===4600?"active":""} onClick={()=>{setLengthMin(4300);setLengthMax(4600);setVisible(24)}}>4.3–4.6m</button><button className={lengthMin===4600&&lengthMax===4900?"active":""} onClick={()=>{setLengthMin(4600);setLengthMax(4900);setVisible(24)}}>4.6–4.9m</button><button className={lengthMin===4900&&lengthMax===lengthCeiling?"active":""} onClick={()=>{setLengthMin(4900);setLengthMax(lengthCeiling);setVisible(24)}}>4.9m以上</button></div><p>{lengthActive?"已隐藏未公布官方车长的记录":"4,000 mm 左端包含所有更短车型；调整区间后仅保留有官方车长的记录"}</p></div><button className="clearPrice" disabled={!lengthActive} onClick={()=>{setLengthMin(lengthFloor);setLengthMax(lengthCeiling);setVisible(24)}}>恢复不限</button></div>
        <div className="priceRangeRow"><span className="filterLabel">价格</span><div className="priceRange"><div className="rangeLabels"><b>{priceMin===0?"不限下限":formatPriceBound(priceMin)}</b><span>人民币估算区间</span><b>{priceMax===priceCeiling?"不限上限":formatPriceBound(priceMax)}</b></div><div className="rangeInputs"><label><small>最低价</small><input aria-label="最低人民币价格" type="range" min="0" max={priceCeiling} step={priceStep} value={priceMin} onInput={e=>{setPriceMin(Math.min(Number(e.currentTarget.value),priceMax-priceStep));setVisible(24)}}/></label><label><small>最高价</small><input aria-label="最高人民币价格" type="range" min="0" max={priceCeiling} step={priceStep} value={priceMax} onInput={e=>{setPriceMax(Math.max(Number(e.currentTarget.value),priceMin+priceStep));setVisible(24)}}/></label></div><div className="pricePresets" aria-label="常用价格区间"><button className={priceMin===0&&priceMax===200000?"active":""} onClick={()=>{setPriceMin(0);setPriceMax(200000);setVisible(24)}}>20万以内</button><button className={priceMin===200000&&priceMax===400000?"active":""} onClick={()=>{setPriceMin(200000);setPriceMax(400000);setVisible(24)}}>20–40万</button><button className={priceMin===400000&&priceMax===priceCeiling?"active":""} onClick={()=>{setPriceMin(400000);setPriceMax(priceCeiling);setVisible(24)}}>40万以上</button></div><p>{priceActive?"已隐藏官网未公开价格的记录":"拖动任一滑块后，将仅保留有官网价格且落在区间内的记录"}</p></div><button className="clearPrice" disabled={!priceActive} onClick={()=>{setPriceMin(0);setPriceMax(priceCeiling);setVisible(24)}}>恢复不限</button></div>
